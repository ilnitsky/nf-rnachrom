process CIGAR_FILTER {
    ...
    script:
    """
    python3 ${projectDir}/scripts/python_scripts_Arina/splicing.py ${contacts} --outdir .
    """
}
...
process BLACKLISTING {
  ...
  script:
  """
  python3 ${projectDir}/scripts/python_scripts_Arina/blacklisting.py ${splice} ${params.blacklist} --outdir .
  """
}

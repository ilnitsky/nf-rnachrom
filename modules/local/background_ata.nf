process BACKGROUND {
    ...
    output:
    tuple val(name), path("*.5-background_sm.bgr")
    ...
    python3 ${projectDir}/bin/rnachrom_pipeline_faster/background.py ${voted}  \\
    ${projectDir}/bin/Smoother smoother.cfg ${chromsizes} \\

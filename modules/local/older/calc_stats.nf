...
process CALC_STATS {
    ...
    tuple val(meta), path(bam_filter_stats)
    tuple val(meta), path(raw_contacts_stats)
    ...
    echo ${bam_filter_stats}
    length_filtered=\$(grep "reads; of these" ${hisat2_stats[0]} | awk '{print \$1}')
    aligned_one_time_rna=\$(grep "aligned exactly 1 time" ${hisat2_stats[0]} | awk '{print \$1}')
    aligned_one_time_dna=\$(grep "aligned exactly 1 time" ${hisat2_stats[1]} | awk '{print \$1}')
    bam_filter_rna=\$(head -n1 ${bam_filter_stats[0]} )
    bam_filter_dna=\$(head -n1 ${bam_filter_stats[1]} )
    raw_contacts=\$(head -n1 ${raw_contacts_stats} )
    ...
    echo -e "Hisat2 uniquely mapped RNA ...............\\t\${aligned_one_time_rna}" >> ${meta.prefix}.stats
    echo -e "Hisat2 uniquely mapped DNA ...............\\t\${aligned_one_time_dna}" >> ${meta.prefix}.stats
    echo -e "BAM filter RNA ..........................\\t\${bam_filter_rna}" >> ${meta.prefix}.stats
    echo -e "BAM filter DNA ..........................\\t\${bam_filter_dna}" >> ${meta.prefix}.stats
    echo -e "Raw contacts ..............................\\t\${raw_contacts}" >> ${meta.prefix}.stats
